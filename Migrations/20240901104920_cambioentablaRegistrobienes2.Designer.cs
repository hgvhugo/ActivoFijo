...
namespace ActivoFijo.Migrations
{
    ...
    [Migration("20240901104920_cambioentablaRegistrobienes2")]
    partial class cambioentablaRegistrobienes2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActivoFijo.Models.RegistroBienes", b =>
                {
                    ...
                    b.HasIndex("CambId")
                        .IsUnique()
                        .HasFilter("[CambId] IS NOT NULL");

                    b.HasIndex("CucopId")
                        .IsUnique()
                        .HasFilter("[CucopId] IS NOT NULL");
                    ...
                    b.HasIndex("PartidaId")
                        .IsUnique()
                        .HasFilter("[PartidaId] IS NOT NULL");

                    b.HasIndex("UbicacionId");

                    b.HasIndex("UnidadAdministrativaId")
                        .IsUnique()
                        .HasFilter("[UnidadAdministrativaId] IS NOT NULL");
